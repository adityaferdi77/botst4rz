...
//
const BotName = 'BOT IDI'; // Nama Bot Whatsapp
const instagramlu = 'instagram.com/afrdy77'; // Nama Instagramlu cok
const whatsapplu = 'wa.me/6283133740589'; // Nomor whatsapplu cok
const kapanbotaktif = 'Kalo gua aktifkan bre...'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/HO1eTqZn7zoHoxQmHtTNgo'; // OFFICIAL GRUP LU 1
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @afrdy77`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @afrdy77`)
})
...
conn.sendMessage(id,'[ ! ] Perintah ini hanya khusus owner BOT IDI BOT', MessageType.text);
}
...
if (text.includes('!randomhentai')){
 var teks = text.replace(/!randomhentai /, '')
  axios.get('https://mhankbarbars.herokuapp.com/api/random/hentai?apiKey=RAPTOR')
   .then((res) => { imageToBase64(res.data.result)
    .then(
     (ress) => {
       conn.sendMessage(id, '[ WAIT ] Sedang di proses⏳ silahkan tunggu sebentar', MessageType.text)
...
if (text.includes('!animewall')){
 var teks = text.replace(/!animewall /, '')
  axios.get('https://mhankbarbars.herokuapp.com/api/random/hentai?apiKey=RAPTOR')
   .then((res) => { imageToBase64(res.data.result)
    .then(
     (ress) => {
...
if (text.includes('!profilig')){
 var teks = text.replace(/!profilig /, '')
...
const teks = text.replace(/!nimequotes /, "")
                 axios.get(`http://mhankbarbars.herokuapp.com/api/quotesnime/random`).then((res) =>{
...
axios.get(`https://mhankbarbars.herokuapp.com/api/kbbi?query=${teks}&lang=id&apiKey=Q70k0Y9YWRSfLfSuhkpf`).then((res) =>{
let hasil = `*KBBI* : \n${res.data.result}`
conn.sendMessage(id, hasil, MessageType.text);
})
}
...
axios.get(`https://mhankbarbars.herokuapp.com/api/jdtv?ch=${teks}&apiKey=RAPTOR`).then((res) =>{
let hasil = `*TV* : *${teks}*\n\n${res.data.result}`
conn.sendMessage(id, hasil, MessageType.text);                                                                        })
}
...
if (text.includes("!twtstalk")){
const teks = text.replace(/!twtstalk /, "")
axios.get(`https://mhankbarbars.herokuapp.com/api/twstalk?username=${teks}&apiKey=RAPTOR`).then ((res) =>{
let hasil = `_*STALK IG*_\n*➸Username* : ${res.data.Username}\n*➸Nama* : ${res.data.Name}\n*➸Follower* : ${res.data.Jumlah_Followers}\n*➸Followed* : ${res.data.Jumlah_Following}\n*➸Jumlah_Postingan* : ${res.data.Jumlah_Post}\n*➸Biodata* : ${res.data.Biodata}\n*_________________________________________*\n\n*➸Profile* : ${res.data.Profile_pic}`;
conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://mhankbarbars.herokuapp.com/api/cuaca?q=${teks}&apiKey=RAPTOR`).then ((res) =>{
...
axios.get(`https://mhankbarbars.herokuapp.com/api/ig?url=${teks}&apiKey=RAPTOR}`).then((res) => {
...
axios.get(`https://mhankbarbars.herokuapp.com/api/twit?url=${teks}&apiKey=RAPTOR`).then((res) => {
...
conn.sendMessage(id, 'command tidak tersedia, ketik !help untuk menampilkan menu' ,MessageType.text);
}
else if (text == '!menu'){
conn.sendMessage(id, 'command tidak tersedia, ketik !help untuk menampilkan menu' ,MessageType.text);
}
...
conn.sendMessage(id, 'kirim !ptl cewek/cowok\n\nContoh: !ptl cewek' ,MessageType.text);
  ...
  // Optical Character Recognition                                                                                         }
   ...
   if (text.includes("!randomh...entai"))
   {
